    ...
    <div className="relative w-full max-w-[520px] mx-auto select-none" style={{ aspectRatio: '1/1' }}>
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="animate-blob-pulse absolute w-72 h-72 rounded-full"
          style={{ background: 'radial-gradient(circle, rgba(186, 96, 23,0.12) 0%, transparent 70%)', top: '10%', left: '15%' }} />
        <div className="animate-blob-pulse absolute w-56 h-56 rounded-full"
          style={{ background: 'radial-gradient(circle, rgba(186, 96, 23,0.10) 0%, transparent 70%)', bottom: '10%', right: '10%', animationDelay: '2s' }} />
      </div>
      ...
      <svg viewBox="0 0 480 480" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        <defs>
          ...
          <linearGradient id="aiGrad" x1="0" y1="0" x2="1" y2="1">
            ...
            <stop offset="100%" stopColor="#ba6017" />
          </linearGradient>
          <linearGradient id="chartGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#ba6017" />
            <stop offset="100%" stopColor="#d47e3b" />
          </linearGradient>
          <linearGradient id="insightGrad" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="#a65615" />
            <stop offset="100%" stopColor="#d47e3b" />
          </linearGradient>
          <linearGradient id="lineGrad" x1="0" y1="0" x2="1" y2="0">
            <stop offset="0%" stopColor="#ba6017" stopOpacity="0" />
            <stop offset="50%" stopColor="#d47e3b" stopOpacity="0.8" />
            <stop offset="100%" stopColor="#ba6017" stopOpacity="0" />
          </linearGradient>
          <filter id="glow">
          ...
          <filter id="softShadow">
            <feDropShadow dx="0" dy="4" stdDeviation="8" floodColor="#ba6017" floodOpacity="0.15" />
          </filter>
        </defs>
        ...
        <g className="animate-float" style={{ animationDelay: '0s' }}>
          ...
          <circle cx="122" cy="60" r="12" fill="#ba6017" />
        ...
        <g className="animate-float-slow" style={{ animationDelay: '1.5s' }}>
          ...
          <rect x="380" y="50" width="8" height="35" rx="2" fill="#ba6017" />
          <rect x="392" y="55" width="8" height="30" rx="2" fill="#a65615" />
          <rect x="404" y="47" width="8" height="38" rx="2" fill="#d47e3b" />
        ...
        <g filter="url(#softShadow)">
          ...
          {/* Inner circle glow */}
          <circle cx="240" cy="240" r="32" fill="#ba6017" opacity="0.4" />
          <circle cx="240" cy="240" r="22" fill="#d47e3b" opacity="0.25" />
        </g>
        {/* AI Text */}
        ...
        {/* Orbit dots */}
        <g>
          <circle cx="240" cy="168" r="6" fill="#d47e3b" filter="url(#glow)" className="animate-pulse-glow" />
          <circle cx="312" cy="240" r="5" fill="#ba6017" filter="url(#glow)" className="animate-pulse-glow" style={{ animationDelay: '0.8s' }} />
          <circle cx="240" cy="312" r="6" fill="#d47e3b" filter="url(#glow)" className="animate-pulse-glow" style={{ animationDelay: '1.6s' }} />
          <circle cx="168" cy="240" r="5" fill="#ba6017" filter="url(#glow)" className="animate-pulse-glow" style={{ animationDelay: '2.4s' }} />
        </g>
        ...
        <g className="animate-float" style={{ animationDelay: '1s' }}>
          ...
          <rect x="408" y="385" width="12" height="40" rx="3" fill="#a65615" />
          ...
          <polyline points="350,403 366,390 382,378 398,372 414,380 430,368"
            stroke="#d47e3b" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"
            filter="url(#glow)" />
          {/* Dots on line */}
          <circle cx="398" cy="372" r="3.5" fill="#d47e3b" filter="url(#glow)" />
          <circle cx="430" cy="368" r="3.5" fill="#d47e3b" filter="url(#glow)" />
        </g>
        ...
        <g className="animate-float-slow" style={{ animationDelay: '2.5s' }}>
          ...
          <rect x="80" y="374" width="30" height="4" rx="2" fill="#ba6017" opacity="0.6" />
          <text x="34" y="373" fill="#64748b" fontSize="7" fontWeight="500">Headcount</text>
          <text x="120" y="373" textAnchor="end" fill="#ba6017" fontSize="8" fontWeight="700">4,820</text>
          ...
          <text x="120" y="399" textAnchor="end" fill="#ba6017" fontSize="8" fontWeight="700">↑ 8.7%</text>

          {/* Donut mini */}
          <circle cx="83" cy="420" r="14" fill="none" stroke="#dbeafe" strokeWidth="5" />
          <circle cx="83" cy="420" r="14" fill="none" stroke="#ba6017" strokeWidth="5"
            strokeDasharray="55 33" strokeLinecap="round"
            style={{ transform: 'rotate(-90deg)', transformOrigin: '83px 420px' }} />
          <circle cx="83" cy="420" r="14" fill="none" stroke="#d47e3b" strokeWidth="5"
        ...
        <g className="animate-float" style={{ animationDelay: '3s' }}>
          ...
          <circle cx="233" cy="91" r="5" fill="#ba6017" />
          <path d="M 224 106 Q 233 100 242 106" stroke="#ba6017" strokeWidth="2" fill="none" strokeLinecap="round" />
        </g>

        {/* ─── Layer 8: Node connections (center orbital) ──────── */}
        <g opacity="0.5">
          <line x1="240" y1="168" x2="240" y2="196" stroke="#d47e3b" strokeWidth="1.5" />
          <line x1="312" y1="240" x2="284" y2="240" stroke="#d47e3b" strokeWidth="1.5" />
          <line x1="240" y1="312" x2="240" y2="284" stroke="#d47e3b" strokeWidth="1.5" />
          <line x1="168" y1="240" x2="196" y2="240" stroke="#d47e3b" strokeWidth="1.5" />
        </g>
        ...
        <g>
          ...
          <rect x="264" y="148" width="52" height="18" rx="9" fill="#ba6017" opacity="0.85" />
          <text x="290" y="161" textAnchor="middle" fill="white" fontSize="7.5" fontWeight="600">AI Parse</text>

          <rect x="264" y="310" width="60" height="18" rx="9" fill="#a65615" opacity="0.85" />
          <text x="294" y="323" textAnchor="middle" fill="white" fontSize="7.5" fontWeight="600">Analytics</text>

          <rect x="155" y="310" width="56" height="18" rx="9" fill="#d47e3b" opacity="0.85" />
